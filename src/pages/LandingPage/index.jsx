...
const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col gap-6 items-center mx-auto text-center xs:max-w-[250px] sm:max-w-[514px] xl:max-w-[768px] 2xl:max-w-[1028px] 3xl:max-w-[1128px] 4xl:max-w-[1228px] 5xl:max-w-[1328px] 6xl:max-w-[1428px]">
