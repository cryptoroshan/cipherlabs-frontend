    ...
    return (
        <section className="sm:min-w-[768px] lg:w-[1056px] flex flex-col justify-center items-center m-auto sm:absolute sm:top-[64px] sm:bottom-[64px] sm:right-0 sm:left-0 mt-[85px] md:mt-0">
            <div className="flex flex-col sm:flex-row items-start justify-between mb-8 px-5 sm:px-0">
                ...
                <img src={journalIcon} className="border-[20px] border-header rounded-2md mb-6 sm:m-8 w-full sm:w-[200px] sm:h-[200px] mx-auto"></img>
                <div className="mx-0 my-0 sm:m-8">
                    ...
                    <div className="text-primary text-base font-medium leading-6">
                        Thanks to dYdX grants, we introduced our MVP <a href="https://www.dydxtradingjournal.app/login"><span className="text-green cursor-pointer">dYdX v3 Trading Journal</span></a>, 
            ...
            <div className="flex flex-col-reverse sm:flex-row items-start justify-between px-5 sm:px-0 my-8 sm:my-0">
                <div className="mx-0 my-0 sm:m-8">
                    ...
                    <div className="text-primary text-base font-medium leading-6">
                    Our <a href="#"><span className="text-green cursor-pointer">dYdX v3 Volume Analytics Dashboard</span></a>, 
                ...
                <img src={analyticsIcon} className="w-full sm:w-[200px] sm:h-[200px] mx-auto border-[20px] border-header rounded-2md mb-6 sm:m-8" />
                {/* <div className="border-[20px] border-header rounded-2md m-8">
