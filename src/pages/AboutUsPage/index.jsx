...
const AboutUsPage = () => {
  return (
    <section className="bg-[url('/imgs/landing/aboutpage_background.jpg')] bg-cover bg-no-repeat bg-center">
      <section className="flex flex-col gap-8 py-[82px] lg:py-[189px] text-primary w-1/2 sm:w-2/3 lg:w-2/5 mx-auto px-[22px] text-justify]">
        <p className="text-[28px] lg:text-5xl font-black">
          Welcome to Cipher Labs:
        </p>
        <section className="flex flex-col gap-4">
          ...
          <p className="text-base italic">
            ...
            traders. Harnessing Web3 technologies, our mission is to redefine
            the DeFi trading landscape. Whether it's advanced trading tools or
            active participation in governance on premier DeFi derivatives
            exchanges, consider us your primary experts for bespoke software
            development designed to enhance your trading experiences.
          </p>
        </section>
        <section className="flex flex-col gap-4">
        ...
        <section className="flex flex-col gap-4">
          ...
          <p className="text-base">
            ...
            traders have all the resources they need at their fingertips,
            enabling them to make informed decisions with ease and confidence.
          </p>
        </section>
        <section className="flex flex-col gap-4">
        ...
        <section className="flex flex-col gap-4">
          ...
          <p className="text-base">
            Under the leadership of our founder Kagan, who spearheads most of
            the product development and design, our team of four combines
            expertise as traders, designers, full-stack engineers, project
            managers, and business strategists. This compact yet diverse skill
            set allows us to provide a holistic approach to DeFi trading
            solutions. By harnessing our collective insights, we tackle
            challenges from multiple angles, consistently innovating to enhance
        ...
        <section className="grid grid-cols-2 xl:grid-cols-4 gap-8 text-base mt-14 mb-12">
          <div className="flex flex-col gap-[21px] items-center justify-between text-center">
            ...
            <div className="flex flex-col gap-[10px] items-center">
              ...
              <a
                href="https://www.linkedin.com/in/kagan-powell-236a3914/"
                target="_blank"
                rel="noreferrer"
              >
                <img src={socialIcon} />
          ...
          <div className="flex flex-col gap-[21px] items-center justify-between text-center">
            ...
            <div className="flex flex-col gap-[10px] items-center">
              ...
              <a
                href="https://www.linkedin.com/in/barrett-ovens-610a8534/"
                target="_blank"
                rel="noreferrer"
              >
                <img src={socialIcon} />
          ...
          <div className="flex flex-col gap-[21px] items-center justify-between text-center">
            ...
            <div className="flex flex-col gap-[10px] items-center">
              ...
              <a
                href="https://www.linkedin.com/in/amir-harambasic/"
                target="_blank"
                rel="noreferrer"
              >
                <img src={socialIcon} />
          ...
          <div className="flex flex-col gap-[21px] items-center justify-between text-center">
            ...
            <div className="flex flex-col gap-[10px] items-center">
              ...
              <a
                href="https://www.linkedin.com/in/ronald-jason-91692b266/"
                target="_blank"
                rel="noreferrer"
              >
                <img src={socialIcon} />
        ...
        <section className="flex flex-col gap-4">
          ...
          <ul className="text-base list-disc ml-10 list-outside">
            <li>
              Secured a grant for building an MVP trading journal for dYdX.
            </li>
            <li>
        ...
        <section className="flex flex-col gap-4">
          ...
          <p className="text-base">
            ...
            current tooling landscape. Then, through agile development
            practices, we create bespoke solutions tailored to meet the specific
            needs of crypto traders.
          </p>
        </section>
        <section className="flex flex-col gap-4">
